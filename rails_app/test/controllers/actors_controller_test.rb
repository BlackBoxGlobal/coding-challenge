...
class ActorsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create actor" do
    assert_difference('Actor.count') do
      post actors_url, params: { actor: { first_name: @actor.first_name, imdb_url: @actor.imdb_url, last_name: @actor.last_name } }
    end
  ...
  test "should update actor" do
    patch actor_url(@actor), params: { actor: { first_name: @actor.first_name, imdb_url: @actor.imdb_url, last_name: @actor.last_name } }
