class ActorsController < ApplicationController
  ...
  before_action :set_characters, only: %i[new edit]
  ...
  def set_characters
    @characters = Character.where(actor_id: nil).pluck(:first_name, :id)
  end

  # Only allow a list of trusted parameters through.
  def actor_params
    params.require(:actor).permit(:first_name, :last_name, :imdb_url,
                                  characters_attributes: %i[id first_name last_name _destroy])
  end
end
